 ...
 * 2) CLOSED - 180 days after expiration the Market enters the terminal CLOSED state, in this state the Market can only sweep leftover tokens to the owner, or destroy itself
