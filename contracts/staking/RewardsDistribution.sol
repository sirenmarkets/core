...
contract RewardsDistribution is Owned, IRewardsDistribution {
    ...
    /**
     * @notice Address of the Siren ERC20 contract
     */
    address public sirenToken;
    ...
    constructor(
        ...
        sirenToken = _sirenToken;
        rewardEscrow = _rewardEscrow;
    }

    // ========== EXTERNAL SETTERS ==========

    function setSirenToken(address _sirenToken) external onlyOwner {
        sirenToken = _sirenToken;
    }
    ...
    function distributeRewards(uint amount) external override returns (bool) {
        ...
        require(sirenToken != address(0), "sirenToken is not set");
        require(
            IERC20(sirenToken).balanceOf(address(this)) >= amount,
        ...
        IERC20(sirenToken).transfer(rewardEscrow, remainder);
     ...
     */
    function distributionsLength() external override view returns (uint) {
