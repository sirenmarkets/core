...
contract StakingRewards is IStakingRewards, RewardsDistributionRecipient, ReentrancyGuardUpgradeSafe, Pausable {
    ...
    function getReward() public override nonReentrant updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            rewardsToken.approve(address(vestingVault), reward);
            vestingVault.addTokenGrant(msg.sender, reward);
