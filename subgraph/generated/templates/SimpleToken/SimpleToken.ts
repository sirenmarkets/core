...
export class TokenDestroyed extends ethereum.Event {
  get params(): TokenDestroyed__Params {
    return new TokenDestroyed__Params(this);
  }
}

export class TokenDestroyed__Params {
  _event: TokenDestroyed;

  constructor(event: TokenDestroyed) {
    this._event = event;
  }
}
...
export class SelfDestructTokenCall extends ethereum.Call {
  get inputs(): SelfDestructTokenCall__Inputs {
    return new SelfDestructTokenCall__Inputs(this);
  }

  get outputs(): SelfDestructTokenCall__Outputs {
    return new SelfDestructTokenCall__Outputs(this);
  }
}

export class SelfDestructTokenCall__Inputs {
  _call: SelfDestructTokenCall;

  constructor(call: SelfDestructTokenCall) {
    this._call = call;
  }
...
export class SelfDestructTokenCall__Outputs {
  _call: SelfDestructTokenCall;
